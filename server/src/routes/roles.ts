...
const ALL_PERMISSIONS = [
  ...
  { code: 'posts.read', label: '查看班级圈', category: '班级圈' },
  { code: 'posts.write', label: '发布帖子', category: '班级圈' },
  { code: 'posts.delete', label: '删除帖子', category: '班级圈' },
  { code: 'posts.comment', label: '发表评论', category: '班级圈' },
